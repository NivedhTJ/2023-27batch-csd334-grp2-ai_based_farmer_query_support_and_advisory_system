...
- **Interactive Web Interface:** Easy-to-use frontend for submitting queries and receiving AI responses.  
...
4. **Access the frontend:**
   ...
   Open the respective HTML pages (e.g., `login_page/login.html`) located inside the `Frontend` directory in your web browser.
---
